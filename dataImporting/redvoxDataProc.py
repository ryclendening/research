...
input_dirMavic: str = "C:\\Users\\rclendening\\EscapeTest_Data\\A2\\A2R7P1\\Phone_3-2"
...
if __name__ == "__main__":
    datawindowMav = dataTools.import_redVoxData(input_dirMavic)
